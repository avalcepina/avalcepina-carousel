...
Create an angular module which includes 'avalcepina-carousel' module, add a controller which exposes a list of images, in small and large size. 
...
(function(angular) {
  ...
  angular.module('myApp', ['avalcepina-carousel'])
